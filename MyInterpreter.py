...
class Interpreter(NodeVisitor):
    ...
    def __init__(self, parser, symtable_builder):
        self.parser = parser
        self.symtable_builder = symtable_builder
    ...
    def interpret(self):
        ...
        self.symtable_builder.visit(tree)
...
def main():
    ...
    lexer = Lexer(text)
    parser = Parser(lexer)
    symtable_builder = SymbolTableBuilder()
    interpreter = Interpreter(parser,symtable_builder)
